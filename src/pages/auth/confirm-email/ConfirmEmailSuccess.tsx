...
export default function ConfirmEmailSuccess() {
  ...
  const successTranslation = useMemo(
    () => t('confirmEmail.success', { returnObjects: true }) as (typeof esAuth)['confirmEmail']['success'],
    [t]
  );
  ...
  return (
    <div className="signup-success">
      ...
      <h2 className="signup-success-title">{successTranslation.title}</h2>
      <p className="signup-success-body">{successTranslation.body}</p>
    </div>
  );
}
